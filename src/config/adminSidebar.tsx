...
const allAdminSidebarItems: SidebarItem[] = [
  ...
  { icon: <ArrowUpCircle className="h-5 w-5" />, label: 'Promotion', path: '/admin/promotion', moduleKey: 'students' },
  { icon: <History className="h-5 w-5" />, label: 'Student History', path: '/admin/student-history', moduleKey: 'students' },
