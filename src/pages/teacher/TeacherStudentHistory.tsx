...
import { Loader2, History, Search, Calendar, FileText } from 'lucide-react';
    ...
    <DashboardLayout sidebarItems={teacherSidebarItems} roleColor="teacher">
      <div className="space-y-6 animate-fade-in">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">View attendance and exam history for any student across all classes.</p>
        </div>
